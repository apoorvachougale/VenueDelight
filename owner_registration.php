...
<body>
 ...
 <div class="wrapper1" >
    <form class="form-signin1"  enctype="multipart/form-data" method="POST" action="owner_reg_php.php" style="box-shadow: 0px 0px 10px rgba(0.2,0,0,0);
  border: 4px solid #8f1537; "> 
    ...
    border-bottom-right-radius: 0;
    padding: 10px;"/><br><br>
     <input type="phone" class="form-control1" name="phone_no" placeholder="Enter Mobile number" required="" autofocus="" style="border-bottom-left-radius: 0;
    border-bottom-right-radius: 0;
    padding: 10px;"/><br><br>
    <label>Aadhar Card</label>
     <input type="file" class="form-control1" name="brow" placeholder="aadhar card"  required="" autofocus="" style="border-bottom-left-radius: 0;
    border-bottom-right-radius: 0;
    padding: 10px;"/><br><br>
    <label>License</label>
     <input type="file" class="form-control1" name="license" placeholder=""  autofocus="" style="border-bottom-left-radius: 0;
    border-bottom-right-radius: 0;
    padding: 10px;"/><br><br>
    ...
    border-top-right-radius: 0;"/> <br>  
     ...
     <center> <button class="btn btn-lg  btn-block" style="background-color: #8f1537; color: #fff; margin-top:20px" name="sub" type="submit">Register</button>   </center>
    </form>
