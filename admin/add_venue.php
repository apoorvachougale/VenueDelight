...
<html>
    <head>
     ...
     <title>Venue Details</title>
      <link rel="stylesheet" href="css/venue1.css">
    ...
    <body>
      ...
      <div class="container">
        <a href="admin_home.php"><button style="background: linear-gradient(-135deg, #8f1537, #c7004c ,#e37070);color: #fff;height: 5%;
                   width: 10%;border-radius: 5px; font-size: 20px;border:none;margin-left: 0%;">BACK</button></a>
      
        
      <div class="text">VENUE DETAILS</div>
      <form name="f" method="post" action="dropbox1.php" enctype="multipart/form-data">
