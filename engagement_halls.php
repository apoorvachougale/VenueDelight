    ...
    <section class="breadcrumbs">
      <div class="container">
       ...
       <!--  <ol>
        ...
        <h2>Engagement Halls</h2> 

      </div>
    </section><br>
<?php
    include "dbconnect.php";
    $query = "SELECT * from `engagement_hall`";
...
<div class="card item-rooms m-sm-3" style="border-radius:30px; box-shadow: 5px 5px 5px 5px #888888;" >
              <div class="card-body">
                ...
                <div class="col-sm-3 " style="background:linear-gradient(#e37070,#8f1537">
                   <a href="engagement_detail.php?owner=<?php echo $row['owner_id'] ?>"><br><br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn m-5 " type="button">View</button></a>
                </div>
