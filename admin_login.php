...
<body>
 ...
 <div class="wrapper1">
    <form class="form-signin1" method="POST" action="admin.php" style="box-shadow: 0px 0px 10px rgba(0.2,0,0,0);
  border: 4px solid #8f1537;  "> 
    <div class="right" >
            
     <center> <h2 class="form-signin1-heading1">Admin login</h2></center><br>
    ...
    border-top-right-radius: 0;"/> <br>     
     ...
     <center> <button class="btn btn-lg  btn-block" style="background-color: #8f1537; color: #fff; margin-top:20px" name="sub" type="submit">Login</button>   </center>
