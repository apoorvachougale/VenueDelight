...
//check if file is exaecutable file 
            ...
            ($_FILES["brows3"]["type"] == "application/x-msdownload"))
           {
               ...
               if(file_exists($newname))
               {
                  ...
                  header("location:meeting.php?msg=file already exist");
               } 
               ...
               {       
                       ...
                       $query= "INSERT INTO  meeting_hall (hallname, contactnumber, email, cost, hallcapacity, facilityavailable, address, description,image1,image2,image3,image4) values('$hallname', '$contactnumber', '$email', '$cost', '$hallcapacity', '$facilityavailable', '$address', '$description','$newname','$newname1','$newname2','$newname3')";
                       
                       $result=mysqli_query($con,$query);
                       
                       if($result)
                       {
                           header("location:meeting.php?msg=hall successfully added");
                       }
                       else{ echo "error";}
        ...
        else{header("location:meeting.php?msg=large file");}   
