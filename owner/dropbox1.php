...
//check if file is exaecutable file 
            ...
            ($_FILES["brows3"]["type"] == "application/x-msdownload"))
           {
               ...
               header("location:wedding.php?msg=can not upload .exe file");
               return ;
           }    
               ...
               if(file_exists($newname))
               {
                  ...
                  header("location:wedding.php?msg=file already exist");
               } 
               ...
               {       
                       ...
                       $query= "INSERT INTO  wedding_hall (owner_id,hallname, contactnumber, email, cost, hallcapacity, facilityavailable, address, description,image1,image2,image3,image4) values('$owner_id', '$hallname', '$contactnumber', '$email', '$cost', '$hallcapacity', '$facilityavailable', '$address', '$description','$newname','$newname1','$newname2','$newname3')";
                       
                       $result=mysqli_query($con,$query);
                       
                       if($result)
                       {
                           header("location:wedding.php?msg=hall successfully added");
                       }
                       else{ echo "error";}
        ...
        else{header("location:wedding.php?msg=large file");}   
