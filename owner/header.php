...
<head>
  ...
  ?>">
  <link rel="stylesheet"  href="css/owner-log.css?v=<?php echo time();
  ?>">
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="logout.php" class="getstarted scrollto" onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Login</a></li>
        </ul>
